...
export default async function handler(req) {
  ...
  if (mode === 'recipe') {
    userPrompt = `Génère une recette AstroFood pour le signe ${sign || 'Bélier'} en langue ${lang}. Format: 1) Nom, 2) intro, 3) ingrédients, 4) préparation numérotée, 5) astuce astro.`;
  }
